...
public class SinglePlayerActivity18 extends ActionBarActivity {
    /*
    ...
    */
    ...
    public static final Integer numberOfTiles = 18;
    //Button definitions
    ImageButton button0;
    ImageButton button1;
    ImageButton button2;
    ...
    Integer tile7 = R.drawable.tile7;
    Integer tile8 = R.drawable.tile8;
    Integer tile9 = R.drawable.tile9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_player_activity18);
        ...
        button12.setOnClickListener(imgButton0Handler12);
        button13.setOnClickListener(imgButton0Handler13);
        button14.setOnClickListener(imgButton0Handler14);
        button15.setOnClickListener(imgButton0Handler15);

        button16.setOnClickListener(imgButton0Handler16);
        button17.setOnClickListener(imgButton0Handler17);
        ...
        button_field[12]=button12;
        button_field[13]=button13;
        button_field[14]=button14;
        button_field[15]=button15;
        button_field[16]=button16;
        button_field[17]=button17;
    ...
    View.OnClickListener imgButton0Handler12 = new View.OnClickListener() {
        int identifier=12;
        public void onClick(View v) {
            //Promjeni identifier na primjereni (npr. 1)
            ...
            Log.d("TAGTAG", "Finished setting FOUND and CHECK fields for button" + identifier);
            Log.d("TAGTAG", "Set TILE " + tiles[identifier] + " on button" + identifier);
            button12.setBackgroundResource(tiles[identifier]);
            Log.d("TAGTAG", "Finished setting data for button" + identifier);
            new Handler().postDelayed(new Runnable() {
    ...
    View.OnClickListener imgButton0Handler13 = new View.OnClickListener() {
        int identifier=13;
        public void onClick(View v) {
            //Promjeni identifier na primjereni (npr. 1)
            ...
            Log.d("TAGTAG", "Finished setting FOUND and CHECK fields for button" + identifier);
            Log.d("TAGTAG", "Set TILE " + tiles[identifier] + " on button" + identifier);
            button13.setBackgroundResource(tiles[identifier]);
            Log.d("TAGTAG", "Finished setting data for button" + identifier);
            new Handler().postDelayed(new Runnable() {
    ...
    View.OnClickListener imgButton0Handler14 = new View.OnClickListener() {
        int identifier=14;
        public void onClick(View v) {
            //Promjeni identifier na primjereni (npr. 1)
            ...
            Log.d("TAGTAG", "Finished setting FOUND and CHECK fields for button" + identifier);
            Log.d("TAGTAG", "Set TILE " + tiles[identifier] + " on button" + identifier);
            button14.setBackgroundResource(tiles[identifier]);
            Log.d("TAGTAG", "Finished setting data for button" + identifier);
            new Handler().postDelayed(new Runnable() {
    ...
    View.OnClickListener imgButton0Handler15 = new View.OnClickListener() {
        int identifier=15;
        public void onClick(View v) {
            //Promjeni identifier na primjereni (npr. 1)
            ...
            Log.d("TAGTAG", "Finished setting FOUND and CHECK fields for button" + identifier);
            Log.d("TAGTAG", "Set TILE " + tiles[identifier] + " on button" + identifier);
            button15.setBackgroundResource(tiles[identifier]);
            Log.d("TAGTAG", "Finished setting data for button" + identifier);
            new Handler().postDelayed(new Runnable() {
    ...
    View.OnClickListener imgButton0Handler16 = new View.OnClickListener() {
        int identifier=16;
        public void onClick(View v) {
            //Promjeni identifier na primjereni (npr. 1)
            ...
            Log.d("TAGTAG", "Finished setting FOUND and CHECK fields for button" + identifier);
            Log.d("TAGTAG", "Set TILE " + tiles[identifier] + " on button" + identifier);
            button16.setBackgroundResource(tiles[identifier]);
            Log.d("TAGTAG", "Finished setting data for button" + identifier);
            new Handler().postDelayed(new Runnable() {
    ...
    View.OnClickListener imgButton0Handler17 = new View.OnClickListener() {
        int identifier=17;
        public void onClick(View v) {
            //Promjeni identifier na primjereni (npr. 1)
            ...
            Log.d("TAGTAG", "Finished setting FOUND and CHECK fields for button" + identifier);
            Log.d("TAGTAG", "Set TILE " + tiles[identifier] + " on button" + identifier);
            button17.setBackgroundResource(tiles[identifier]);
            Log.d("TAGTAG", "Finished setting data for button" + identifier);
            new Handler().postDelayed(new Runnable() {
